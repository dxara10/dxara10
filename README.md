...
<ul>
  <li>
    ...
    <a class="falling-link" href="https://github.com/dxara10/StudyAsync" style="display:inline-block; position:relative; transition:transform 0.5s ease, opacity 0.5s ease;">Study Environment, with Asynchronous contributions</a>
  </li>
</ul>
